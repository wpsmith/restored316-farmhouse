 ...
 * Farmhouse Theme.
 *
 * This file adds the WooCommerce styles and the Customizer additions for WooCommerce to the Farmhouse Theme.
 *
...
add_filter( 'woocommerce_enqueue_styles', 'farmhouse_woocommerce_styles' );
/**
 ...
 */
function farmhouse_woocommerce_styles( $enqueue_styles ) {

	$enqueue_styles[ genesis_get_theme_handle() . '-woocommerce-styles' ] = [
		'src'     => CHILD_URL . '/lib/woocommerce/farmhouse-woocommerce.css',
		'deps'    => '',
...
add_action( 'wp_enqueue_scripts', 'farmhouse_woocommerce_css' );
/**
 ...
 */
function farmhouse_woocommerce_css() {
	...
	$woo_css .= ( farmhouse_get_default_link_color() !== $color_link ) ? sprintf(
		'
	...
	$woo_css .= ( farmhouse_get_default_button_color() !== $color_button ) ? sprintf(
		'
