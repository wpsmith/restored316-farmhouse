...
(function ($, Cookies) {
    ...
    $(window).scroll(function () {
        ...
        bannerheight = $('.farmhouse-top-banner').outerHeight();
    ...
    function showBanner() {
        $('.farmhouse-top-banner').fadeIn(function () {
            $(this).children('#farmhouse-top-banner-close').animate({
                opacity: 1
            }, 1000);
    ...
    function closeBanner() {
        $('#farmhouse-top-banner-close').click(function () {
